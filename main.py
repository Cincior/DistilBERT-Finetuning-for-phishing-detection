...
if os.path.exists(save_path):
    ...
    dataset = load_dataset("csv", data_files="phishing_email.csv", delimiter=",", column_names=["text", "label"])
...
# Funkcja do wyciągania fragmentów zdania
...
explain_prediction("URGENT: Your PayPal account has been suspended. Please log in at http://secure-paypal-login.com to verify your identity immediately.")
explain_prediction("Congratulations! You've been selected to receive a $1000 Walmart Gift Card. Click here to claim your reward!")
explain_prediction("Invoice INV-99283 is overdue. Please download the attached PDF to avoid late fees and legal action.")
explain_prediction("Dear Customer, we noticed suspicious activity on your credit card. Confirm your details now to prevent card blocking: http://bit.ly/bank-secure-auth")
explain_prediction("I am a lawyer representing a deceased relative who left you $10.5M. Please reply with your bank details to initiate the transfer.")
explain_prediction("Hi team, are we still meeting at 3 PM in the conference room? Let me know if we need to reschedule.")